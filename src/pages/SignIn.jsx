    ...
    <div>
      ...
      <div className='my-10 pb-10 pt-5'>
        ...
        <div className='mx-auto mb-7 text-center'>
            <Link to="/signIn" className='font-medium uppercase pb-2 px-11' style={styles.header}>Sing in</Link>
            <Link to="/register" className='font-medium uppercase px-11 ' style={styles.headSame}>Register</Link>
        </div>
        <div className='flex flex-col align-middle justify-center mx-auto mb-10 pb-10' >
            <h2 className='uppercase font-medium text-center'>welcome back</h2>
            ...
            <form action="" className='flex flex-col align-middle justify-center mx-auto' style={styles.form}> 
                <input type="email" name="email" id="email" placeholder='Email' className='py-2 px-1' style={styles.input} required />
